...
fn run_in_out_pixel_based_kernel_1f(context: &Context, kernel: &Kernel, pixel_count: usize, input: &SvmVec<u8>, output: &mut SvmVec<u8>, queue: &CommandQueue, value: f32) -> Duration {
